...
noDataForLocationText = {
    ...
    'fr-FR': [u"Désolé, je n'ai pas les prévisions pour votre emplacement."]
}

dailyForcast = {
    'de-DE': [u"Hier ist die Vorhersage für {0}, {1}"],
    'en-US': [u"This is the forecast for {0}, {1}"],
    'fr-FR': [u"Voici les prévisions météo pour {0}, {1}"]
}
