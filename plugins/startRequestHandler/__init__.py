...
webSearchAnswerText = {"de": u"Das Web nach {0} durchsuchen …", "en": u"Searching the web for {0} …", "fr": u"Recherche de {0} sur le web…", "nl": u"Zoeken op het web voor {0} …"}
webSearchAnswerFailureText = {"de": u"Entschuldigung, Ich, ich kann jetzt nicht das Web durchsuchen.", "en": u"Sorry but I cannot search the web right now.", "fr": u"Désolé, je ne peux pas chercher sur le web maintenant.", "nl": u"Excuses, maar ik kan nu niet het web doorzoeken."}
