...
class DisplayPicture(Plugin):
    ...
    @register("fr-FR", u"(montre|affiche|recherche|cherche|dessine)?.*(photos?|images?|dessins?|illustrations?|affiche.moi|dessine.moi) (une?|pour|de la|de l'|des|du|de|d'une?|d'|l')* ?([\w ]+)")
